...
export const metadata: Metadata = { title: 'Data Dispatches' }
export default function Page() {
  return (
    <>
      <PageHeader eyebrow="Writing · Data Dispatches" title="Data Dispatches" sub="Content forthcoming. Subscribe for updates." />
      <Rule />
