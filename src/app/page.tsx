...
export const metadata: Metadata = {
  title: 'Clarity Intelligence — AI Workforce Intelligence',
  description: 'Traditional benchmarks measure hierarchy. We measure what survives AI. Task-level workforce intelligence for Vietnam and Southeast Asia.',
}
