...
export const metadata: Metadata = { title: 'Wora Working Group' }
export default function Page() {
  return (
    <>
      <PageHeader eyebrow="Writing · Wora Working Group" title="Wora Working Group" sub="Content forthcoming. Subscribe for updates." />
      <Rule />
